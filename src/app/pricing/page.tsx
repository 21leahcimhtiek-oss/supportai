        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-violet-600/10 border border-violet-500 rounded-2xl p-8 text-left relative">
            ...
            <ul className="space-y-3 mb-8 text-sm">
              ...
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>AI ticket routing</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Auto-responses</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Knowledge base AI</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Sentiment analysis</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Human handoff</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Multi-channel support</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>SLA tracking</li>
              <li className="flex items-center gap-2 text-gray-300 text-sm"><span className="text-green-400">+</span>Analytics & reports</li>
            </ul>
